...
namespace Motorcycle_Rental_Tests.Unit.LocationUseCases
{
    public class CreateLocationUseCaseTest
    {
        ...
        public async Task Create_ShouldReturn201_WhenSuccess()
        {
            ...
            // Act
            var result = await controller.Create(new CreateLocationDTO(), useCaseMock.Object, _loggerMock.Object, Mock.Of<IDeliveryManRepository>(), Mock.Of<IMotorcycleRepository>());
